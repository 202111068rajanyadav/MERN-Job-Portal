...
const PostJob = () => {
  ...
  return (
    <div className='max-w-screen-2x1 container mx-auto xl:px-24 px-4'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}  className="space-x-0">
     {/*  1st row */}
 ...
 {/* 5th row  */}
    ...
    <div className="lg:w-1/2 w-full">
        ...
        <option value="Work remotely">Work remotely</option>
            ...
            rows={6}
            defaultValue={" You can add more information regarding the job and also specify the area "}
